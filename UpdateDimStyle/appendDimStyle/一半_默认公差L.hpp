varAns.emplace(LR"(一半_默认公差L)", ApplyMaps::value_type::second_type{
	[](simple_code_args,
...
/******************************************************************/
	...
	/*线*******************************/
	{
		argR->setDimclrd(31_ac)/*尺寸线颜色*/;
		argR->setDimclre(30_ac)/*尺寸界限颜色*/;

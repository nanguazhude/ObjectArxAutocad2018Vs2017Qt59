		...
		for (const auto & varC : varChars) {
			...
			if constexpr(true) {/*镜像*/
				const static std::set<std::string_view> varKeyWord{
					...
					u8R"(逼)"sv,u8R"(邪)"sv,u8R"(人)"sv,
					u8R"(傻)"sv,u8R"(教)"sv,u8R"(权)"sv,
					u8R"(功)"sv,u8R"(党)"sv,u8R"(8)"sv,
					u8R"(习)"sv,u8R"(共)"sv,u8R"(九)"sv,
					u8R"(革)"sv,u8R"(国)"sv,u8R"(六)"sv,
					u8R"(色)"sv,u8R"(民)"sv,u8R"(4)"sv,
					u8R"(裸)"sv,u8R"(文)"sv,u8R"(隐)"sv,
					u8R"(激)"sv,u8R"(化)"sv,u8R"(私)"sv,
					u8R"(日)"sv,u8R"(育)"sv,u8R"(饥)"sv,
					u8R"(法)"sv,u8R"(主)"sv,u8R"(渴)"sv,
					u8R"(货)"sv,u8R"(自)"sv,u8R"(姓)"sv,
					u8R"(残)"sv,u8R"(穆)"sv,u8R"(也)"sv,
					u8R"(赵)"sv,u8R"(林)"sv,
					u8R"(台)"sv,u8R"(斯)"sv,
					u8R"(情)"sv,u8R"(治)"sv,
					u8R"(轮)"sv,u8R"(安)"sv,

#include <set>
#include "AddMaskToDim.hpp"

namespace sstd {

	AddMaskToDim::AddMaskToDim() {

	}

	extern void loadAddMaskToDim() { AddMaskToDim::load(); }

	void AddMaskToDim::load() {
		arx_add_main_command<AddMaskToDim>();
	}
